...
class TableMaster extends MY_Controller
{
    ...
    {
        $data = [
            'title' => 'Teen Patti Table Master Management',
            'AllTableMaster' => $this->TableMaster_model->AllTableMasterList()
        ];
        $data['SideBarbutton'] = ['backend/TableMaster/add', 'Add Teen Patti Table Master'];
    ...
    {
        $data = [
            'title' => 'Add Teen Patti Table Master'
        ];
    ...
    {
        $data = [
            'title' => 'Edit Teen Patti Table Master',
    ...
    public function insert()
    {
        ...
        if ($TableMaster) {
            $this->session->set_flashdata('msg', array('message' => 'Teen Patti Table Master Added Successfully', 'class' => 'success', 'position' => 'top-right'));
        } else {
            $this->session->set_flashdata('msg', array('message' => 'Somthing Went Wrong', 'class' => 'error', 'position' => 'top-right'));
        }
        redirect('backend/TableMaster');
