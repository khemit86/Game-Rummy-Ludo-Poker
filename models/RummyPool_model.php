...
class RummyPool_model extends MY_Model
{
    ...
    {
        $this->db->select('tbl_rummy_pool_table_master.*,COUNT(tbl_users.id) AS online_members,tbl_rummy_pool_table.no_of_players');
        $this->db->from('tbl_rummy_pool_table_master');
        $this->db->join('tbl_rummy_pool_table', 'tbl_rummy_pool_table_master.boot_value=tbl_rummy_pool_table.boot_value AND tbl_rummy_pool_table.isDeleted=0', 'left');
